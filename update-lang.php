<?php
  ...
  // --- 1. Read values from the form (using $_POST) ---
  // The ID is essential to know WHICH record to update
  $lang_id = $_POST['LangID'] ?? null;
  ...
  // --- 2. SECURITY: Escape inputs before using them in the query string ---
